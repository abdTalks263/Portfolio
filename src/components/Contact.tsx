...
const Contact: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (formSectionRef.current) {
      formSectionRef.current.classList.add('fade-in-on-scroll');
      observer.observe(formSectionRef.current);
    }

    if (infoSectionRef.current) {
      infoSectionRef.current.classList.add('fade-in-on-scroll');
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "LinkedIn",
      value: "linkedin.com/in/muhammad-abdullah-latif-70b8b7237",
      link: "https://www.linkedin.com/in/muhammad-abdullah-latif-70b8b7237/",
      gradient: "from-secondary to-primary"
    }
  ];

  return (
    <section id="contact" className="py-20 bg-dark-light relative overflow-hidden">
      {/* Section Divider */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div ref={formSectionRef} className="space-y-6">
            ...
            <div className="bg-dark/50 backdrop-blur-sm border border-border-light rounded-2xl p-8 hover:border-primary/40 transition-all duration-300">
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-dark border border-border-light rounded-lg focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all duration-300 text-text-primary placeholder-text-muted hover:border-primary/40"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 bg-dark border border-border-light rounded-lg focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all duration-300 resize-none text-text-primary placeholder-text-muted hover:border-primary/40"
            ...
            <div className="space-y-4">
              {contactInfo.map((info, index) => (
                <a
                  ...
                  className="bg-dark/50 backdrop-blur-sm border border-border-light rounded-xl p-6 hover:border-primary/40 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/10 group block"
                >
                  <div className="flex items-start space-x-4">
                    <div className={`w-12 h-12 bg-gradient-to-br ${info.gradient} rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg group-hover:scale-110 transition-transform duration-300`}>
            ...
            <div className="pt-6">
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  className="w-12 h-12 bg-primary/20 rounded-xl flex items-center justify-center text-primary hover:bg-primary/30 transition-all duration-300 hover:scale-110 hover:rotate-12 border border-primary/30"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.047-1.852-3.047-1.853 0-2.136 1.445-2.136 2.939v5.677H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
